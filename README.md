...
Telegram bot for HR allows you to collect data from recruiters: CV, name, @telegramname, cellphonenumber and save it to dockerhub and deploy into google cloud.
